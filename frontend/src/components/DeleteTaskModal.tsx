                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <motion.div
                            ...
                            className="inline-block align-bottom bg-[hsl(var(--background))] rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full relative"
                        >
                            ...
                            <div className="bg-[hsl(var(--muted))] dark:bg-[hsl(var(--muted))] px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    type="button"
